...
# Ensure tools are in PATH for macros like AKS2C
export PATH := $(CPCT_PATH)tools/scripts:$(CPCT_PATH)tools/sdcc-3.6.8-r9946/bin:$(CPCT_PATH)tools/hex2bin-2.0/bin:$(PATH)
...
# PROJNAME   := brickb
Z80CODELOC := 0x1C00
# Safety zone after 0x1A00  0x2700
...
CDT     = $(DISTDIR)/$(PROJNAME)_$(LANG_SUFFIX).cdt
DSK     = $(DISTDIR)/$(PROJNAME)_$(LANG_SUFFIX).dsk
