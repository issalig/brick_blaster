...
const translations = {
    ...
    fr: {
        ...
        creditsPowered: "PROPULSÉ PAR CPCTELERA",
        creditsYear: "2026",
    ...
    pt: {
        title: "Brick Blaster",
        subtitle: "MISSÃO DE RECUPERAÇÃO DA VESPA",
        controls: "CONTROLOS",
        moveLeft: "ESQUERDA",
        moveRight: "DIREITA",
        fire: "DISPARO",
        ...
        music: "MÚSICA",
        menuNav: "MENU",
        difficultyAdj: "DIFICULDADE",
        storyTitle: "HISTÓRIA",
        story1: "Era uma manhã qualquer. Ia ao pão de Mafra, mas o <strong>Manuel o Marciano</strong> roubou-te a Vespa. Agora estás preso numa <strong>prisão espacial de tijolos</strong>.",
        story2: "A tua arma: uma tábua de engomar e uma bola de ténis nuclear. ¡Recupera a mota e volta a tempo para o bacalhau!",
        about: "SOBRE",
        aboutText: "Bem-vindo ao <strong>Brick Blaster</strong>, um clone de Arkanoid de alta voltagem para o Amstrad CPC. Navega na tua nave, apanha power-ups e destrói tijolos.",
        creditsCode: "CÓDIGO E GFX: ISSALIG",
        creditsMusic: "MÚSICA: ULTRASYD",
