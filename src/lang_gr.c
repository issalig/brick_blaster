...
static const u8 s_gr_STR_C_DESC[] = "KOLLWDHS";
static const u8 s_gr_STR_P_DESC[] = "DWRAKI";
static const u8 s_gr_STR_B_DESC[] = "MAGIKH PORTA";
static const u8 s_gr_STR_E_DESC[] = "XXL RAKETA";
static const u8 s_gr_STR_M_DESC[] = "POLLAPLH BALA!";
static const u8 s_gr_STR_I_DESC[] = "PAGOY";
static const u8 s_gr_STR_U_DESC[] = "APWTHHTIKO";
static const u8 s_gr_STR_A_DESC[] = "AYTOPILOTOS";
static const u8 s_gr_STR_D_DESC[] = "PIWMENOS";
static const u8 s_gr_STR_V_DESC[] = "METEORWN";
static const u8 s_gr_STR_T_DESC[] = "TO MEGETHOS METRA";
static const u8 s_gr_STR_F_DESC[] = "PYRINH BALA";

static const u8 s_gr_STR_CONGRATS[] = "SYGXARHTHRIA!";
static const u8 s_gr_STR_RECOVERED_MOTO[] = "VRETHIKE H MOTO SOY.";
static const u8 s_gr_STR_NOW_GO_BREAD[] = "TWRA MPOREIS TELIKA";
static const u8 s_gr_STR_NOW_GO_BREAD_2[] = "NA PAS GIA PSWMI";
static const u8 s_gr_STR_EAT_SANDWICH[] = "KAI NA FAS ENA";
static const u8 s_gr_STR_SQUID_BOCATA[] = "NOSTIMO PITOGYRO.";
static const u8 s_gr_STR_GAME_OVER[] = "GAME OVER";
static const u8 s_gr_STR_NO_MOTO_NO_EAT[] = "OYTE MOTO, OYTE PSWMI";
static const u8 s_gr_STR_GAME_OVER_SUB2[] = "PAIXE XANA GIA TO FAGHTO SOY";
...
static const u8 s_gr_STR_STORY_3[] = "O AREIANOS EKLEPSE TO SKOYTER.";
static const u8 s_gr_STR_STORY_4[] = "TWRA EISAI PAGIDEYMENOS";
static const u8 s_gr_STR_STORY_5[] = "SE MIA FYLAKH APO TOYBLA.";
static const u8 s_gr_STR_STORY_6[] = "TO OPLO SOY: MIA SIDERWSTRA";
...
static const u8 s_gr_STR_DEMO[] = "DEMO";
static const u8 s_gr_STR_DIFFICULTY[] = "DYSKOLIA: ";
