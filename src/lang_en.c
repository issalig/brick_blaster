...
static const u8 s_en_STR_KEY_LEFT[] = "LEFT:";
static const u8 s_en_STR_MOVE_LEFT[] = "LEFT/MENU UP";
static const u8 s_en_STR_KEY_RIGHT[] = "RIGHT:";
static const u8 s_en_STR_MOVE_RIGHT[] = "RIGHT/MENU DOWN";
static const u8 s_en_STR_KEY_SPACE[] = "SPACE:";
static const u8 s_en_STR_FIRE[] = "FIRE/SELECT";
...
static const u8 s_en_STR_KEY_P[] = "P:";
static const u8 s_en_STR_PADDLE[] = "PADDLE";
...
const u8* const lang_en[STR_COUNT] = {
    ...
    s_en_STR_KEY_SPACE, s_en_STR_FIRE, s_en_STR_KEY_ESC, s_en_STR_PAUSE, s_en_STR_KEY_M, s_en_STR_MUSIC, s_en_STR_KEY_P, s_en_STR_PADDLE, s_en_STR_CAPSULE_GUIDE, s_en_STR_CLUELESS, s_en_STR_L_DESC, s_en_STR_S_DESC,
